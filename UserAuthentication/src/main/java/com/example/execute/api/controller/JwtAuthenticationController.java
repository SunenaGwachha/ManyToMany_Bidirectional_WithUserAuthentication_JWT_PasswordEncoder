...
import com.example.execute.api.config.JwtTokenUtil;
...
public class JwtAuthenticationController {
	...
	public ResponseEntity<?> createAuthenticationToken(@RequestBody Credentials authenticationRequest) throws Exception {
	...
	public ResponseEntity<?> saveUser(@RequestBody User user) throws Exception {
		...
		if (credentialService.findByUserName(user.getCredentials().getUsername())==null) {
